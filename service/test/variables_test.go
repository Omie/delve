...
func TestPackageRenames(t *testing.T) {
	...
	testcases := []varTest{
		...
		{"iface3", true, `interface {}(*github.com/omie/delve/_fixtures/vendor/dir0/renamedpackage.SomeType) *{A: true}`, "", "interface {}", nil},
		...
		{"dir0someType", true, "interface {}(*github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType) *{X: 3}", "", "interface {}", nil},
		{"dir1someType", true, "interface {}(github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType) {X: 1, Y: 2}", "", "interface {}", nil},
		{"amap3", true, "interface {}(map[github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType]github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType) [{X: 4}: {X: 5, Y: 6}, ]", "", "interface {}", nil},
		{"anarray", true, `interface {}([2]github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType) [{X: 1},{X: 2}]`, "", "interface {}", nil},
		{"achan", true, `interface {}(chan github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType) chan github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType 0/0`, "", "interface {}", nil},
		{"aslice", true, `interface {}([]github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType) [{X: 3},{X: 4}]`, "", "interface {}", nil},
		{"afunc", true, `interface {}(func(github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType, github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType)) main.main.func1`, "", "interface {}", nil},
		{"astruct", true, `interface {}(*struct { A github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType; B github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType }) *{A: github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType {X: 1, Y: 2}, B: github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType {X: 3}}`, "", "interface {}", nil},
		{"astruct2", true, `interface {}(*struct { github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType; X int }) *{SomeType: github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType {X: 1, Y: 2}, X: 10}`, "", "interface {}", nil},
		{"iface2iface", true, `interface {}(*interface { AMethod(int) int; AnotherMethod(int) int }) **github.com/omie/delve/_fixtures/vendor/dir0/pkg.SomeType {X: 4}`, "", "interface {}", nil},
	...
	withTestProcess("pkgrenames", t, func(p proc.Process, fixture protest.Fixture) {
		...
		for _, tc := range testcases {
			if ver.Major > 0 && !ver.AfterOrEqual(goversion.GoVersion{1, 9, -1, 0, 0, ""}) {
				...
				if tc.name == "astruct2" {
					tc.value = `interface {}(*struct { github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType; X int }) *{github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType: github.com/omie/delve/_fixtures/vendor/dir1/pkg.SomeType {X: 1, Y: 2}, X: 10}`
				}
			}
			variable, err := evalVariable(p, tc.name, pnormalLoadConfig)
			if tc.err == nil {
