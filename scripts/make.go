...
const DelveMainPackagePath = "github.com/omie/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/omie/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/omie/delve/pkg/proc", "github.com/omie/delve/service/test", "github.com/omie/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/omie/delve/service/test"}
